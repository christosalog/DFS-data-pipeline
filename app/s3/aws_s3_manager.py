...
def upload_object(data, bucket: str, key: str,
                  grant_read: str = None) -> bool:
    """
    ...
    csv_buffer.seek(0)
    try:
        s3_client.put_object(Body=csv_buffer.getvalue(), Bucket=bucket, GrantRead=grant_read, Key=key)
